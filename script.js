document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    clearFieldError(field);
    field.classList.add('field--valid', 'valid');
    return true;
  }
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    successEl.style.cssText = 'padding:12px 16px;background:#c6f6d5;color:#276749;border-radius:6px;margin-top:12px;font-weight:500;';
    form.appendChild(successEl);

    form.reset();
    fields.forEach(function (field) {
      field.classList.remove('field--valid', 'valid', 'field--error', 'error');
    });
  ...
  document.body.addEventListener('input', function (e) {
    const field = e.target;
    if (!field.closest('.contact-form')) return;
    if (field.classList.contains('field--error') || field.classList.contains('error')) {
      validateField(field);
    }
  });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Buy a Brainrot משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '5d39c6f5-6536-472e-b27e-f8e5502816a9',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '5d39c6f5-6536-472e-b27e-f8e5502816a9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5d39c6f5-6536-472e-b27e-f8e5502816a9';
